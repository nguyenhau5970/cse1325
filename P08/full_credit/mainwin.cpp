...
Mainwin::Mainwin() {
    ...
    Gtk::ToolButton *insert_student = Gtk::manage(new Gtk::ToolButton(*insert_student_image));
    ...
    Gtk::ToolButton *insert_parent = Gtk::manage(new Gtk::ToolButton(*insert_parent_image));
    ...
    Gtk::ToolButton *relate = Gtk::manage(new Gtk::ToolButton(*relate_image));
    ...
    //NEW COURSE ICON
    Gtk::Image* course_image = Gtk::manage(new Gtk::Image{"new_course.png"});
    Gtk::ToolButton *course= Gtk::manage(new Gtk::ToolButton(*course_image));
    course->set_tooltip_markup("Relate Student to Parent");
    course->signal_clicked().connect([this] {this->on_new_course_click();});
    toolbar->append(*course);

    //NEW SECTION ICON
    Gtk::Image* section_image = Gtk::manage(new Gtk::Image{"new_section.png"});
    Gtk::ToolButton *section = Gtk::manage(new Gtk::ToolButton(*section_image));
    section->set_tooltip_markup("Relate Student to Parent");
    section->signal_clicked().connect([this] {this->on_new_section_click();});
...
void Mainwin::on_about_click() {
    ...
    std::vector< Glib::ustring > artists = {
        ...
        "\n Code adopted from GNU General Public License 3 (GPL3), https://www.gnu.org/licenses/gpl-3.0.en.html"
    };
    dialog.set_artists(artists);
    dialog.run();
}
